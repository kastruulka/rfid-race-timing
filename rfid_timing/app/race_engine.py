...
from ..services.results.penalty_service import PenaltyService
from ..services.results.finish_service import FinishService
from ..services.runtime.lap_service import LapService
from ..services.runtime.start_service import StartService
...
class RaceEngine:
    def __init__(
        ...
        self.laps = LapService(
            ...
            finalize_time_limit_category=self.finishes.finalize_time_limit_category,
        )
    ...
    def finalize_time_limit_category(
        ...
        return self.finishes.finalize_time_limit_category(category_id, now_ms=now_ms)

    def finalize_time_limit_categories(self, now_ms: int | None = None) -> int:
        return self.finishes.finalize_time_limit_categories(now_ms=now_ms)
