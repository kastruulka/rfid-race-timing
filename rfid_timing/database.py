...
from .services.category_reset_service import CategoryResetService
...
class Database:
    ...
    # Result writes + repository-backed reads
    def create_result(
        self,
        rider_id: int,
        category_id: int,
    ...
    # Lap writes + repository-backed reads
    def record_lap(
        self,
        result_id: int,
        lap_number: int,
